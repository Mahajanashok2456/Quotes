      ...
      {quote && (
        ...
        >
          <motion.div
            ...
            className="relative w-full max-w-2xl max-h-[85vh] flex flex-col rounded-xl border border-red-500/50 bg-deep-teal-900 shadow-2xl"
          >
            {/* Close Button */}
            <button
              onClick={onClose}
            ...
            <div className="overflow-y-auto p-8 space-y-6 text-center">
              <div
                className="markdown-content font-serif text-2xl md:text-3xl leading-relaxed"
                style={{
              ...
              <div className="flex items-center justify-center">
                <div
                  className="h-px w-20 bg-slate-blue/50"
                  style={{
                    backgroundColor:
                ...
                />
                <p
                  className="mx-4 font-sans text-xl"
                  style={{
                    fontFamily: quote.font_family || "Arial, sans-serif",
                    color: quote.font_color || "#000000",
                  }}
